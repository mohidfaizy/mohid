...
// Show Services Modal
const modalBoxs = document.querySelectorAll('.services__modal'),
      modalButtons = document.querySelectorAll('.services__button'),
      modalClose = document.querySelectorAll('.services__modal_close')
let modalAdd = function(modalClick){
    modalBoxs[modalClick].classList.add('active-modal')
}
let modalRemove = function(modalClick){
    modalBoxs[modalClick].classList.remove('active-modal')
}
modalButtons.forEach((name, id)=>{
    name.addEventListener('click',() => {
        modalAdd(id)
    })
})
modalClose.forEach((name, id) => {
    name.addEventListener('click',()=>{
        modalRemove(id)
    }) 
})
